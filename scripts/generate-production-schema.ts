 ...
 * 
 * Generates a comprehensive production-schema.sql file from shared/schema.ts
...
async function generateProductionSchema() {
  console.log('🔨 Generating production-schema.sql...');
  console.log(`Version: ${SCHEMA_VERSION}`);
  console.log(`Date: ${LAST_UPDATED}\n`);

  let sql = SQL_HEADER;

  // Add core tables with complete SQL
  sql += generateMerchantsTable();
  sql += generateApiMerchantsTable();
  sql += generateApiTerminalsTable();
  sql += generateTransactionsTable();
  sql += generateUploadedFilesTable();
  sql += generateTddfBatchHeadersTable();
  sql += generateTddfTransactionRecordsTable();
  sql += generateTddfPurchasingExtensionsTable();
  sql += generateTddfRecordsTable();
  sql += generateUsersTable();
  sql += generateApiUsersTable();
  sql += generateConnectionLogTable();
  sql += generateIpBlocklistTable();
  sql += generateHostApprovalsTable();
  sql += generateAuditLogsTable();
  sql += generateUploaderUploadsTable();
  sql += generateCacheConfigurationTable();
  sql += generatePreCacheTables();
  sql += generateSystemTablesTable();
  
  sql += SQL_FOOTER;

  // Write to file
  const outputPath = path.join(process.cwd(), 'production-schema.sql');
...
function generateMerchantsTable(): string {
  return `
-- =====================================================================
-- MERCHANTS TABLE
-- =====================================================================
...
function generateApiMerchantsTable(): string {
  return `
-- =====================================================================
-- API MERCHANTS TABLE
-- =====================================================================
...
function generateApiTerminalsTable(): string {
  return `
-- =====================================================================
-- API TERMINALS TABLE
-- =====================================================================
...
function generateTransactionsTable(): string {
  return `
-- =====================================================================
...
function generateUploadedFilesTable(): string {
  return `
-- =====================================================================
...
function generateTddfBatchHeadersTable(): string {
  return `
-- =====================================================================
...
function generateTddfTransactionRecordsTable(): string {
  return `
-- =====================================================================
...
function generateTddfPurchasingExtensionsTable(): string {
  return `
-- =====================================================================
...
function generateTddfRecordsTable(): string {
  return `
-- =====================================================================
...
function generateUsersTable(): string {
  return `
-- =====================================================================
-- USERS TABLE
-- =====================================================================
...
function generateApiUsersTable(): string {
  return `
-- =====================================================================
-- API USERS TABLE
-- =====================================================================
...
function generateConnectionLogTable(): string {
  return `
-- =====================================================================
...
function generateIpBlocklistTable(): string {
  return `
-- =====================================================================
-- IP BLOCKLIST TABLE
-- =====================================================================
...
function generateHostApprovalsTable(): string {
  return `
-- =====================================================================
...
function generateAuditLogsTable(): string {
  return `
-- =====================================================================
-- AUDIT LOGS TABLE
-- =====================================================================
...
function generateUploaderUploadsTable(): string {
  return `
-- =====================================================================
...
function generateCacheConfigurationTable(): string {
  return `
-- =====================================================================
...
function generatePreCacheTables(): string {
  return `
-- =====================================================================
-- PRE-CACHE TABLES
-- =====================================================================
...
function generateSystemTablesTable(): string {
  return `
-- =====================================================================
-- SYSTEM TABLES
-- =====================================================================
...
// Run the generator
generateProductionSchema().catch(console.error);
