...
function TddfRecordDetails({ record, formatCurrency, formatTableDate }: { 
  ...
  const allFields = [
    ...
    { label: 'Purchase ID (288-311)', value: record.purchaseId, mono: true },
    { label: 'Cash Back Amount (312-322)', value: record.cashBackAmount ? formatCurrency(record.cashBackAmount) : 'N/A' },
    { label: 'Cash Back Amount Sign (323-323)', value: record.cashBackAmountSign, mono: true },
    { label: 'POS Data Code (324-334)', value: record.posDataCode, mono: true },
    { label: 'Transaction Type Identifier (335-338)', value: record.transactionTypeIdentifier, mono: true },
    { label: 'Card Type Extended (339-339)', value: record.cardTypeExtended, mono: true },
