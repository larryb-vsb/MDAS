    ...
    <div className={`min-h-screen transition-colors p-2 sm:p-4 ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
      <div className="max-w-7xl mx-auto space-y-2 sm:space-y-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          <Card className={`lg:col-span-2 transition-colors ${isDarkMode ? 'bg-gray-900 border-gray-600' : 'bg-gray-50 border-gray-300'}`}>
            <CardHeader className="pb-2">
              <div className="flex items-center justify-between">
                <CardTitle className={`flex items-center gap-2 text-sm font-medium transition-colors ${isDarkMode ? 'text-gray-100' : 'text-gray-900'}`}>
                  <BarChart3 className="h-4 w-4" />
                  <span className="hidden sm:inline">Daily - {format(selectedDate, 'MMM d')}</span>
                ...
                <Button
                  ...
                  className="flex items-center gap-1"
                >
                  <RefreshCw className={`h-3 w-3 ${dayLoading ? 'animate-spin' : ''}`} />
                    ...
                    <Table>
                      ...
                      <TableBody>
                        {(() => {
                          ...
                          const recordTypes = dayBreakdown.recordTypes || dayBreakdown.recordTypeBreakdown || {};
