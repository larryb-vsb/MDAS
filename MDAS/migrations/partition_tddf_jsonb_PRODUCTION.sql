-- ============================================================================
-- QUARTERLY PARTITIONING MIGRATION FOR tddf_jsonb (PRODUCTION)
-- ============================================================================
...
-- 
-- Date Range: 2021-Q1 through 2026-Q1 (with auto-creation for future quarters)
...
-- Step 3: Create quarterly partitions from 2021-Q1 through 2026-Q1
-- 2021
...
ALTER TABLE tddf_jsonb ADD PRIMARY KEY (id, batch_date);
