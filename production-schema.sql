...
CREATE TABLE IF NOT EXISTS api_achtransactions (
  id text NOT NULL DEFAULT nextval('dev_api_achtransactions_id_seq'::regclass),
...
CREATE TABLE IF NOT EXISTS api_terminals (
  id integer NOT NULL DEFAULT nextval('dev_api_terminals_id_seq'::regclass),
...
CREATE TABLE IF NOT EXISTS api_users (
  id integer NOT NULL DEFAULT nextval('dev_api_users_id_seq'::regclass),
...
CREATE TABLE IF NOT EXISTS audit_logs (
  id integer NOT NULL DEFAULT nextval('dev_audit_logs_id_seq'::regclass),
...
CREATE TABLE IF NOT EXISTS cache_configuration (
  id integer NOT NULL DEFAULT nextval('dev_cache_configuration_id_seq'::regclass),
...
CREATE TABLE IF NOT EXISTS connection_log (
  id integer NOT NULL DEFAULT nextval('dev_connection_log_id_seq'::regclass),
  timestamp timestamp NOT NULL DEFAULT now(),
...
CREATE TABLE IF NOT EXISTS dashboard_cache (
  id integer NOT NULL DEFAULT nextval('dev_dashboard_cache_id_seq'::regclass),
...
CREATE TABLE IF NOT EXISTS host_approvals (
  id integer NOT NULL DEFAULT nextval('dev_host_approvals_id_seq'::regclass),
...
CREATE TABLE IF NOT EXISTS ip_blocklist (
  id integer NOT NULL DEFAULT nextval('dev_ip_blocklist_id_seq'::regclass),
...
CREATE TABLE IF NOT EXISTS master_object_keys (
  id integer NOT NULL DEFAULT nextval('dev_master_object_keys_id_seq'::regclass),
...
CREATE TABLE IF NOT EXISTS merchant_mcc_schema (
  ...
  created_at timestamp NOT NULL DEFAULT now(),
  updated_at timestamp NOT NULL DEFAULT now(),
  id integer NOT NULL DEFAULT nextval('dev_merchant_mcc_schema_id_seq'::regclass),
  key text,
  tab_position text
);
...
CREATE TABLE IF NOT EXISTS pre_cache_runs (
  id integer NOT NULL DEFAULT nextval('dev_pre_cache_runs_id_seq'::regclass),
...
CREATE TABLE IF NOT EXISTS processing_metrics (
  id integer NOT NULL DEFAULT nextval('dev_processing_metrics_id_seq'::regclass),
...
CREATE TABLE IF NOT EXISTS processing_timing_logs (
  id integer NOT NULL DEFAULT nextval('dev_processing_timing_logs_id_seq'::regclass),
...
CREATE TABLE IF NOT EXISTS security_logs (
  id integer NOT NULL DEFAULT nextval('dev_security_logs_id_seq'::regclass),
...
CREATE TABLE IF NOT EXISTS sub_merchant_terminals (
  id integer NOT NULL DEFAULT nextval('dev_sub_merchant_terminals_id_seq'::regclass),
...
CREATE TABLE IF NOT EXISTS system_logs (
  id integer NOT NULL DEFAULT nextval('dev_system_logs_id_seq'::regclass),
...
CREATE TABLE IF NOT EXISTS system_settings (
  id integer NOT NULL DEFAULT nextval('dev_system_settings_id_seq'::regclass),
...
CREATE TABLE IF NOT EXISTS tddf_api_files (
  id integer NOT NULL DEFAULT nextval('dev_tddf_api_files_id_seq'::regclass),
...
CREATE TABLE IF NOT EXISTS tddf_api_keys (
  id integer NOT NULL DEFAULT nextval('dev_tddf_api_keys_id_seq'::regclass),
...
CREATE TABLE IF NOT EXISTS tddf_api_queue (
  id integer NOT NULL DEFAULT nextval('dev_tddf_api_queue_id_seq'::regclass),
  file_id integer,
...
CREATE TABLE IF NOT EXISTS tddf_api_records (
  id integer NOT NULL DEFAULT nextval('dev_tddf_api_records_id_seq'::regclass),
  file_id integer,
...
CREATE TABLE IF NOT EXISTS tddf_api_request_logs (
  id integer NOT NULL DEFAULT nextval('dev_tddf_api_request_logs_id_seq'::regclass),
  api_key_id integer,
  endpoint text NOT NULL,
  method text NOT NULL,
...
CREATE TABLE IF NOT EXISTS tddf_api_schemas (
  id integer NOT NULL DEFAULT nextval('dev_tddf_api_schemas_id_seq'::regclass),
...
CREATE TABLE IF NOT EXISTS tddf_archive (
  id integer NOT NULL DEFAULT nextval('dev_tddf_archive_id_seq'::regclass),
...
CREATE TABLE IF NOT EXISTS tddf_archive_records (
  id integer NOT NULL DEFAULT nextval('dev_tddf_archive_records_id_seq'::regclass),
  upload_id text,
...
CREATE TABLE IF NOT EXISTS tddf_batch_headers (
  id integer NOT NULL DEFAULT nextval('dev_tddf_batch_headers_id_seq'::regclass),
...
CREATE TABLE IF NOT EXISTS tddf_datamaster (
  id integer NOT NULL DEFAULT nextval('dev_tddf_datamaster_id_seq'::regclass),
...
CREATE TABLE IF NOT EXISTS tddf_import_log (
  id integer NOT NULL DEFAULT nextval('dev_tddf_import_log_id_seq'::regclass),
...
CREATE TABLE IF NOT EXISTS tddf_json_record_type_counts_pre_cache (
  id integer NOT NULL DEFAULT nextval('dev_tddf_json_record_type_counts_pre_cache_id_seq'::regclass),
...
CREATE TABLE IF NOT EXISTS tddf_jsonb (
  id integer NOT NULL DEFAULT nextval('dev_tddf_jsonb_id_seq'::regclass),
  upload_id text NOT NULL,
  filename text NOT NULL,
  record_type text NOT NULL,
...
CREATE TABLE IF NOT EXISTS tddf_other_records (
  id integer NOT NULL DEFAULT nextval('dev_tddf_other_records_id_seq'::regclass),
  record_type text NOT NULL,
...
CREATE TABLE IF NOT EXISTS tddf_purchasing_extensions (
  id integer NOT NULL DEFAULT nextval('dev_tddf_purchasing_extensions_id_seq'::regclass),
...
CREATE TABLE IF NOT EXISTS tddf_raw_import (
  id integer NOT NULL DEFAULT nextval('dev_tddf_raw_import_id_seq'::regclass),
...
CREATE TABLE IF NOT EXISTS tddf_records (
  id integer NOT NULL DEFAULT nextval('dev_tddf_records_id_seq'::regclass),
...
CREATE TABLE IF NOT EXISTS terminals (
  id integer NOT NULL DEFAULT nextval('dev_terminals_id_seq'::regclass),
  v_number text NOT NULL,
  pos_merchant_number text,
  bin text,
  dba_name text,
...
CREATE TABLE IF NOT EXISTS transactions (
  id integer NOT NULL DEFAULT nextval('dev_transactions_id_seq'::regclass),
...
CREATE TABLE IF NOT EXISTS uploaded_files (
  id integer NOT NULL DEFAULT nextval('dev_uploaded_files_id_seq'::regclass),
  filename varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS uploader_json (
  id integer NOT NULL DEFAULT nextval('dev_uploader_json_id_seq'::regclass),
  upload_id text NOT NULL,
  raw_line_data text,
...
CREATE TABLE IF NOT EXISTS uploader_mastercard_di_edit_records (
  id integer NOT NULL DEFAULT nextval('dev_uploader_mastercard_di_edit_records_id_seq'::regclass),
  upload_id text NOT NULL,
  record_data jsonb NOT NULL,
  processing_status text DEFAULT 'pending'::text,
  created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP
...
CREATE TABLE IF NOT EXISTS uploader_tddf_jsonb_records (
  id integer NOT NULL DEFAULT nextval('dev_uploader_tddf_jsonb_records_id_seq'::regclass),
  upload_id text NOT NULL,
  record_type text NOT NULL,
  record_data jsonb NOT NULL,
...
CREATE TABLE IF NOT EXISTS users (
  id integer NOT NULL DEFAULT nextval('dev_users_id_seq'::regclass),
