...
- **Persistent Dark Mode & Enhanced PDF Reports (2025-08-02)**: Added dark_mode boolean column to users table with API endpoint `/api/user/dark-mode` for saving preferences. Dark/light mode choice now persists across browser sessions and logins. Enhanced PDF export includes ASCII-style charts with transaction value comparisons, comprehensive daily breakdowns, record type descriptions, performance metrics, and month-over-month analysis data.
